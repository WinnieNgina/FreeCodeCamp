...
do
{
    ...
    Console.WriteLine(" 2. Display all dogs with a specified characteristics");
    Console.WriteLine();
    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            var dogCharacteristicArray = dogCharacteristic.Split(',');
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                if (ourAnimals[i, 1].Contains("dog"))
                {
                    ...
                    {
                        string Characteristic = dogCharacteristicArray[j];
